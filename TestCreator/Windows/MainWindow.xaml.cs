...
namespace TestCreator
{
    public partial class MainWindow : Window
    {
        ...
        {
            groups.Clear();
            ObservableCollection<UserGroup> groups2 = Client.getUserGroupsByUser(StaticObject.mainUser);
        ...
        public static void updatePassedTest()
        {
            ...
            foreach (PassedTest p in StaticObject.mainUser.passedTests)
            {
                passedTests.Add(p);
            }
        }
        ...
        public static void updateTest()
        {
            ...
            tests.Clear();
            foreach (Test test in StaticObject.mainUser.tests)
            {
                tests.Add(test);
            }
        }
        ...
        private void Button_Click_OpenMyProfile(object sender, RoutedEventArgs e)
        {
            ...
            window.init(StaticObject.mainUser, null);
            window.Show();
            winds.Add(window);
